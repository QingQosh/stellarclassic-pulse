...
- `EMAIL_FORMAT`: Email body format — `text` (default), `html`, or `both`. See [HTML Emails](#html-emails).
- `EMAIL_API_BASE_URL`: Base URL used to build clickable links in HTML emails (default: `https://soroban-pulse.example.com`)
